...
module.exports = __webpack_require__(/*! /Users/stasbelinsky/Documents/WebStorm/angular-gtag-test/src/main.ts */"zUnb");
...
AboutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AboutComponent, selectors: [["app-about"]], decls: 4, vars: 2, consts: [[3, "routerLink"]], template: function AboutComponent_Template(rf, ctx) { if (rf & 1) {
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 4, vars: 2, consts: [[3, "routerLink"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
...
class AppComponent {
    constructor(router) {
        this.title = 'angular-gtag-test';
        const navEndEvent = router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_0__["NavigationEnd"]));
